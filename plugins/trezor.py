...
from electrum_verge.account import BIP32_Account
from electrum_verge.bitcoin import EncodeBase58Check, public_key_to_bc_address, bc_address_to_hash_160
from electrum_verge.i18n import _
from electrum_verge.plugins import BasePlugin, hook, always_hook, run_hook
from electrum_verge.transaction import deserialize
from electrum_verge.wallet import BIP32_HD_Wallet
from electrum_verge.util import print_error
from electrum_verge.wallet import pw_decode, bip32_private_derivation, bip32_root
...
class TrezorQtHandler:
    ...
    def passphrase_dialog(self):
        from electrum_verge_gui.qt.password_dialog import make_password_dialog, run_password_dialog
        d = QDialog()
        d.setModal(1)
