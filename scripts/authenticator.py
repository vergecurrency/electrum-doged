...
from electrum_xvg.transaction import Transaction
from electrum_xvg.bitcoin import base_encode, base_decode
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-xvg/authenticator')
