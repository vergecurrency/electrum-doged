...
ELECTRUM_GIT_URL=git://github.com/vergecurrency/electrum-xvg.git
BRANCH=master
NAME_ROOT=electrum-xvg
...
cp -r electrum-git $WINEPREFIX/drive_c/electrum-xvg
...
#cp "$WINEPREFIX/drive_c/Program Files (x86)/ZBar/bin/"*.dll "$WINEPREFIX/drive_c/electrum-xvg/"
