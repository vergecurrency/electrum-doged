...
_ = lambda x:x
#from i18n import _
from electrum_verge.util import format_satoshis, set_verbosity
from electrum_verge.util import StoreDict
from electrum_verge.bitcoin import is_valid

from electrum_verge import Wallet, WalletStorage
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid VERGEcoin address'))
            return
        try:
