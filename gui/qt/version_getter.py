...
from electrum_verge import ELECTRUM_VERSION, print_error
...
class VersionGetter(threading.Thread):
    ...
    def run(self):
        try:
            con = httplib.HTTPSConnection('electrum-verge.org', timeout=5)
...
class UpdateLabel(QLabel):
    ...
    def open_website(self):
        webbrowser.open("http://electrum-verge.space/")
        self.dialog.done(0)
