...
from electrum_zcl.bitcoin import is_valid
...
import re
import time
from electrum_zcl.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_zcl import util
import datetime

from electrum_zcl.version import ELECTRUM_VERSION as electrum_version
from electrum_zcl.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Zclassic address or contact"))
        ...
        self.setWindowTitle("Electrum-ZCL")
    ...
    def the_website(self):
        webbrowser.open("https://zclassic.org")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Zclassic address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Zclassic payment"))
